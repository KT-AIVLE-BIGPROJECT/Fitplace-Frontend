...
import { Button, Col, Form, Row, Container, FloatingLabel, ButtonGroup } from 'react-bootstrap';
    ...
    <Layout>
      <Container className='container_style' style={{minHeight: "75vh"}}>
        ...
        <Form.Group>
          ...
          <Form.Select aria-label="Default select example" size="sm" defaultValue={mbti} onChange={selectMbti}>
